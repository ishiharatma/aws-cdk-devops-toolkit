...
import { Ec2AutoStartStopStack } from '../lib/ec2-auto-start-stop-stack';
...
new Ec2AutoStartStopStack(app, 'Ec2AutoStartStopStack', {
  pjName: projectName,
  envName: envName,
  description: 'Automatically start and stop EC2 instances based on tags and scheduled events.',
  functionName: 'ec2-auto-start-stop',
  //snsTopicArn: '',
